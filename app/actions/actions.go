...
var DefaultActions = map[string]string{
	write_file: "Use this action to create a new file or overwrite existing content. " +
	...
	edit_file: "Use this action to modify an existing file without losing its original content. " +
	...
	list_files: "Use this action to generate a tree listing of files in a specified directory. " +
